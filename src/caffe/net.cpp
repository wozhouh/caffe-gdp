...
void Net<Dtype>::update_filter_contrib_total(float pruning_rate){
  ...
  for(int layer_id = 0; layer_id < conv_layer_ids_.size(); ++layer_id){
    ...
    filter_contrib_total_.insert(filter_contrib_total_.end(), 
                                  layers_[conv_layer_ids_[layer_id]] -> blobs()[0] -> filter_contrib().begin(), 
                                  layers_[conv_layer_ids_[layer_id]] -> blobs()[0] -> filter_contrib().end());
  }
